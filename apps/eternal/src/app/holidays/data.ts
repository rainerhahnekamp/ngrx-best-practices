...
export const holidays: Holiday[] = [
  ...
  },
  {
    ...
    description: `Get to know different aspects of Austria. Hike mountains in Tyrol,
    relax in Burgenland, enjoy the rich culture of Vienna, Salzburg, Graz or Innsbruck`,
