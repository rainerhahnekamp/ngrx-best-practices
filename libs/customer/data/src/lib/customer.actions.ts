...
const updated = createAction('[Customer] Updated', props<{ customers: Customer[]; redirect: UrlTree }>());

const remove = createAction('[Customer] Remove', props<{ customer: Customer; redirect: UrlTree }>());
const removed = createAction('[CUSTOMER] Removed', props<{ customers: Customer[]; redirect: UrlTree }>());
