...
export class CustomerEffects {
  getCustomer$ = createEffect(() =>
    this.actions$.pipe(
      ...
      concatMap((action) => of(action).pipe(withLatestFrom(this.store.select(fromCustomer.selectLoadStatus)))),
  ...
  addCustomer$ = createEffect(() =>
    this.actions$.pipe(
      ...
      concatMap(({ customer }) => this.http.post<Customer[]>(this.baseUrl, customer)),
  ...
  updateCustomer$ = createEffect(() =>
    this.actions$.pipe(
      ...
      concatMap(({ customer }) => this.http.put<Customer[]>(this.baseUrl, customer)),
  ...
  removeCustomer$ = createEffect(() =>
    this.actions$.pipe(
      ...
      concatMap(({ customer }) => this.http.delete<Customer[]>(`${this.baseUrl}/${customer.id}`)),
